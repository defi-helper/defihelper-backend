...
export * as metricsContractWatcherBroker from './metrics/contractWatcherBroker';
export * as metricsContractHistory from './metrics/contractHistory';
export * as metricsContractWatcherHistory from './metrics/contractWatcherHistory';
...
export * as metricsContractWatcherDate from './metrics/contractWatcherDate';
...
export * as subscribeToEventFromWatcher from './watcher/subscribeToEvent';
export * as registerContractInWatcher from './watcher/registerContract';
export * as watcherSyncContractFid from './watcher/syncContractFid';
...
export * as followContractEvent from './watcher/followContractEvent';
